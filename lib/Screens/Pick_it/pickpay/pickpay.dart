...
import 'package:flutter_k/Screens/Pick_it/wait/pickwait.dart';
import 'package:flutter_k/export.dart';

class PickPaymentScreen extends StatefulWidget {
  final List<Cart> cartItems;
  final String email;

  const PickPaymentScreen({
    Key? key,
  ...
  @override
  _PickPaymentScreenState createState() => _PickPaymentScreenState();
}

class _PickPaymentScreenState extends State<PickPaymentScreen> {
  String? _message;
  ...
  Future<void> saveData(
    ...
    CollectionReference collectionReference =
        FirebaseFirestore.instance.collection('PickWaiting');
    try {
  ...
  Future<void> _confirmPaymentAndNavigate(BuildContext context) async {
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => const PickWaitScreen(),
        ),
      );
    } catch (e) {
