import 'package:flutter_k/Screens/Pick_it/menu/pickmenu.dart';
import 'package:flutter_k/export.dart';

class PickSearchScreen extends StatefulWidget {
  final String email;
  const PickSearchScreen({Key? key, required this.email}) : super(key: key);

  @override
  _PickSearchScreenState createState() => _PickSearchScreenState();
}

class _PickSearchScreenState extends State<PickSearchScreen> {
        ...
        return InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PickMenuScreen(
                  email: resData.email,
                  cartItems: const [],
                ),
              ),
